        ...
        but.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Notification not1 = new Notification.Builder(MainActivity.this)
                        ...
                        .setContentTitle("jayanth\'s Notification")
                        .setContentText("This is Notification Example")
                        .setSmallIcon(R.drawable.ic_baseline_notifications_active_24)
                        .addAction(R.drawable.ic_baseline_smart_button_24, "Action 1", pi1)
                        .addAction(R.drawable.ic_baseline_smart_button_24, "Action 2", pi1)
